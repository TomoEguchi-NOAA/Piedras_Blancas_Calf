...
# Some issues with dropped years for recent year datasets. Also I wanted to
# add visibility, Beaufort, and observer codes for using them as potential
# covariates that affected sighting probabilities. 
