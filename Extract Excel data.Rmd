...
formatted.inshore <- format.output(data.shift, max.shift = max(data.shift$Shift))

out.list <- list(data.offshore = NA,
              data.inshore = data.inshore,
              shift.data.offshore = NA,
              shift.data.inshore = data.shift,
              formatted.data.offshore = NA,
