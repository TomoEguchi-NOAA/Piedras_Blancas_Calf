...
col.types.inshore <- c("date", "numeric", "text", 
                       "numeric", "numeric",
                       "numeric", "numeric", "text", 
                       "text")

col.types.offshore <- c("date", "numeric", "text", 
                        "numeric", "numeric",
                        "numeric", "numeric", "numeric", 
                        "text", "text")

col.names.inshore <- c("Date", "Event", "Time", "Obs. Code", 
                       "Sea State", "Vis. IN", "Cow  / Calf")

col.names.offshore <- c("Date", "Event", "Time", 
                        "Obs.", "Sea State", 
...
col.names.inshore <- c("Date",	"Event Code",	"Time",	"Observer Code",	
                       "Sea State",	"Vis In",	"Vis Out",	"C/C Pairs",
                       "Adults",	"JUV",	"In/Out",	"Time In",	
                       "Time Out", "Reticle",	"Angle",	"Comments")

col.names.offshore <- c("Date",	"Event",	"Time",	"OBS.",
                        "Vis.",	"Sea",	"Cow/Calf",	"Adult",
                        "JUV",	"Reticle",	"Angle",	"Comments")
